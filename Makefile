...
lint:
	find ./ -type f -regextype egrep  -regex ".*\.(cpp|hpp|cu|h)"  -not -path "./build/*" -not -path "./cmake-build-debug/*" | xargs oclint -p build/compile_commands.json -disable-rule=ShortVariableName
